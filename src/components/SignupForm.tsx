...
export default function SignupForm({
  ...
  return (
    <form onSubmit={handleSignup} className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 w-80 flex flex-col gap-4">
      <h2 className="text-primary-700 dark:text-primary-300 font-semibold text-lg text-center">Create Account</h2>
      ...
      <button type="button" onClick={onLogin} className="text-sm text-primary-500 hover:underline text-center">
